...
function addSiswa($data)
{
	...
	$query = mysqli_query($conn, "INSERT INTO siswa VALUES ('', '$nama_siswa', '$jenis_kelamin', '$no_telepon', '$nim')");
	return mysqli_affected_rows($conn);
}
...
function editSiswa($data)
{
	...
	$no_telepon = htmlspecialchars($data['no_telepon']);
	$nim = htmlspecialchars($data['nim']);
	$query = mysqli_query($conn, "UPDATE siswa SET nama_siswa = '$nama_siswa', jenis_kelamin = '$jenis_kelamin', no_telepon = '$no_telepon', nim = '$nim' WHERE id_siswa = '$id_siswa'");
	return mysqli_affected_rows($conn);
}
