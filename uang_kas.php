...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
              ...
              <div class="col-lg-3">
                <div class="card shadow">
                  <div class="card-body">
                    ...
                    <a href="detail_bulan_pembayaran.php?id_bulan_pembayaran=<?= $dbp['id_bulan_pembayaran']; ?>" class="btn btn-info">
                      <i class="fas fa-fw fa-align-justify"></i></a>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2022 By Taronet</strong>
      All rights reserved.
